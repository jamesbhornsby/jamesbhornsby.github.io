...
After some time spent learning GLSL and much time learning to load models, I am now applying calculus to 3D physics simulations and using OpenGL to render rather sightly graphical representations.
